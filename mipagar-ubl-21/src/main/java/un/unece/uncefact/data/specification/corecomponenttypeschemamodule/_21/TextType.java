...
import oasis.names.specification.ubl.schema.xsd.unqualifieddatatypes_21.NameType;
...
@XmlSeeAlso({
    NameType.class,
    oasis.names.specification.ubl.schema.xsd.unqualifieddatatypes_21.TextType.class
})
