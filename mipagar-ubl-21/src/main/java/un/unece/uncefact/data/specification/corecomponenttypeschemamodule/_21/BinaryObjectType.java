...
import oasis.names.specification.ubl.schema.xsd.unqualifieddatatypes_21.GraphicType;
import oasis.names.specification.ubl.schema.xsd.unqualifieddatatypes_21.PictureType;
import oasis.names.specification.ubl.schema.xsd.unqualifieddatatypes_21.SoundType;
import oasis.names.specification.ubl.schema.xsd.unqualifieddatatypes_21.VideoType;
...
@XmlSeeAlso({
    ...
    GraphicType.class,
    SoundType.class,
    oasis.names.specification.ubl.schema.xsd.unqualifieddatatypes_21.BinaryObjectType.class,
    PictureType.class
})
