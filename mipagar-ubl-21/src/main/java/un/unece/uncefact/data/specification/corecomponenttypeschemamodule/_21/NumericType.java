...
import oasis.names.specification.ubl.schema.xsd.unqualifieddatatypes_21.RateType;
import oasis.names.specification.ubl.schema.xsd.unqualifieddatatypes_21.ValueType;
...
@XmlSeeAlso({
    PercentType.class,
    ValueType.class,
    oasis.names.specification.ubl.schema.xsd.unqualifieddatatypes_21.NumericType.class,
    RateType.class
})
